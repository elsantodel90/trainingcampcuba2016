...
\item También es posible encontrar si utilizamos este orden, el camino 420 en orden lexicográfico (ejercicio).
\end{itemize}
\end{frame}
...
\pause
\item Ejercicio: Pensar algo mejor para evitar tener que repetir el cálculo de la tabla de DP para cada pez.
